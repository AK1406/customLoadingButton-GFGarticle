...
class LoadingButton @JvmOverloads constructor(
    ...
    //tells the compiler that the value of a variable must never be cached as its value may change outside
    @Volatile
...
//initialize
    init {
        ...
        valueAnimator = AnimatorInflater.loadAnimator(
            context, R.animator.loading_animation    //properties for downloading progress is defined
        ) as ValueAnimator
        ...
        try {
            ...
            attr.recycle() //clearing all the data associated with attribute
        }
    }
